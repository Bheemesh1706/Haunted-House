...
const door = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        displacementBias: doorHeightTexture,
...
//Bushes
const bushGeomentry = new THREE.SphereGeometry(1, 16, 16);
const bushMaterial = new THREE.MeshStandardMaterial({ color: "#89c854" });

const bush1 = new THREE.Mesh(bushGeomentry, bushMaterial);
bush1.scale.set(0.5, 0.5, 0.5)
bush1.position.set(0.8, 0.2, 2.2)

const bush2 = new THREE.Mesh(bushGeomentry, bushMaterial);
bush2.scale.set(0.25, 0.25, 0.25)
bush2.position.set(1.4, 0.1, 2.1)


const bush3 = new THREE.Mesh(bushGeomentry, bushMaterial);
bush3.scale.set(0.4, 0.4, 0.4)
bush3.position.set(-1.4, 0.1, 2.2)

const bush4 = new THREE.Mesh(bushGeomentry, bushMaterial)
...
const graveGeomentry = new THREE.BoxGeometry(0.5, 0.8, 0.25)
